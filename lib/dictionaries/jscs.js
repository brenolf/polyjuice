module.exports = {
  ...
  'requireSpacesInFunction': function (value) {
    if (value.beforeOpeningRoundBrace) {
      return {
  ...
  'disallowSpacesInAnonymousFunctionExpression': function (value) {
    if (value.beforeOpeningRoundBrace) {
      return {
        'space-before-function-paren': [2, 'never']
      }
  ...
  'requireSpacesInAnonymousFunctionExpression': function (value) {
    if (value.beforeOpeningRoundBrace) {
      return {
        'space-before-function-paren': [2, 'always']
      }
  ...
  'requireSpacesInNamedFunctionExpression': function (value) {
    if (value.beforeOpeningRoundBrace) {
      return {
        'space-before-function-paren': [2, 'always']
      }
  ...
  'requireVarDeclFirst': 'vars-on-top',
  ...
  'disallowSpaceBeforePostfixUnaryOperators': {
    name: 'space-unary-ops',
    truthy: [2, { words: false, nonwords: false }]
  },
