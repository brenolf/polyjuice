module.exports = {
  ...
  'requireSpaceAfterLineComment': {
    ...
    _truthy: function () {
      if (this != false) {
        this[1]['afterBlockComment'] = true;
        this[1]['afterLineComment'] = true;
